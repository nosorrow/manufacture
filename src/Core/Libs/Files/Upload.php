...
class Upload
{
    ...
    public function __construct()
    {
        ...
        $this->directory =
            PUBLIC_DIR . Config::getConfigFromFile('upload_directory');
    ...
    public function check_mime($temp = '', $file_name = '')
    {
        ...
        if (function_exists('mime_content_type')) {
            ...
            throw new \Exception(
                'mime_content_type fuction is not exists. Maybe fileinfo extension  is not allowed'
            );
        }
            ...
            if (
                ...
                if (move_uploaded_file($temp, $file_path)) {
                    $this->response[] = [
                        'file_name' => $response['basename'],
                        'file_path' =>
                            $response['dirname'] . '/' . $response['basename'],
                        'directory' => $response['dirname'],
                        'url' =>
                            site_url($response['dirname']) .
                            '/' .
